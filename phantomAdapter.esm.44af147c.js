...
})({"1Hd44":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "5ff81c3544af147c";
"use strict";
...
},{}],"k0UIM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PhantomAdapter", ()=>PhantomAdapter);
...
const detectProvider = async function() {
    ...
    if (isPhantomAvailable) return window.solana;
...
class PhantomAdapter extends (0, _baseSolanaAdapter.BaseSolanaAdapter) {
    constructor(){
        super(...arguments);
        (0, _definePropertyDefault.default)(this, "name", (0, _base.WALLET_ADAPTERS).PHANTOM);
        ...
        (0, _definePropertyDefault.default)(this, "_wallet", null);
        (0, _definePropertyDefault.default)(this, "phantomProvider", null);
        (0, _definePropertyDefault.default)(this, "_onDisconnect", ()=>{
            if (this._wallet) {
                this._wallet.off("disconnect", this._onDisconnect);
                this.rehydrated = false;
                // ready to be connected again only if it was previously connected and not cleaned up
                this.status = this.status === (0, _base.ADAPTER_STATUS).CONNECTED ? (0, _base.ADAPTER_STATUS).READY : (0, _base.ADAPTER_STATUS).NOT_READY;
    ...
    get isWalletConnected() {
        var _this$_wallet;
        return !!((_this$_wallet = this._wallet) !== null && _this$_wallet !== void 0 && _this$_wallet.isConnected && this.status === (0, _base.ADAPTER_STATUS).CONNECTED);
    }
    get provider() {
    ...
    async init() {
        ...
        if (!this._wallet) throw (0, _base.WalletInitializationError).notInstalled();
        this.phantomProvider = new (0, _solanaProvider.PhantomInjectedProvider)({
            config: {
                chainConfig: this.chainConfig
            }
        });
        this.status = (0, _base.ADAPTER_STATUS).READY;
        this.emit((0, _base.ADAPTER_EVENTS).READY, (0, _base.WALLET_ADAPTERS).PHANTOM);
        try {
            (0, _base.log).debug("initializing phantom adapter");
            if (options.autoConnect) {
                this.rehydrated = true;
                await this.connect();
            }
        } catch (error) {
            (0, _base.log).error("Failed to connect with cached phantom provider", error);
    ...
    async connect() {
        ...
        try {
            ...
            this.emit((0, _base.ADAPTER_EVENTS).CONNECTING, {
                adapter: (0, _base.WALLET_ADAPTERS).PHANTOM
            });
            if (!this._wallet) throw (0, _base.WalletInitializationError).notInstalled();
            if (!this._wallet.isConnected) {
                ...
                try {
                    await new Promise((resolve, reject)=>{
                        ...
                        if (!this._wallet) {
                            reject((0, _base.WalletInitializationError).notInstalled());
                            return;
                        }
                        ...
                        this._wallet._handleDisconnect = function() {
                            reject((0, _base.WalletInitializationError).windowClosed());
                    ...
                    throw (0, _base.WalletLoginError).connectionError(error === null || error === void 0 ? void 0 : error.message);
                } finally{
                    this._wallet._handleDisconnect = handleDisconnect;
                }
            } else await this.connectWithProvider(this._wallet);
            if (!this._wallet.publicKey) throw (0, _base.WalletLoginError).connectionError();
    ...
    async disconnect() {
        ...
        try {
            ...
            this.emit((0, _base.ADAPTER_EVENTS).ERRORED, (0, _base.WalletLoginError).disconnectionError(error === null || error === void 0 ? void 0 : error.message));
        }
    }
    async getUserInfo() {
        if (!this.isWalletConnected) throw (0, _base.WalletLoginError).notConnectedError("Not connected with wallet, Please login/connect first");
        return {};
    }
    async addChain(chainConfig) {
        ...
        (_this$phantomProvider2 = this.phantomProvider) === null || _this$phantomProvider2 === void 0 || _this$phantomProvider2.addChain(chainConfig);
    ...
    async connectWithProvider(injectedProvider) {
        if (!this.phantomProvider) throw (0, _base.WalletLoginError).connectionError("No phantom provider");
...
},{"@babel/runtime/helpers/defineProperty":"4x6r7","@web3auth/base":"7HmU4","@web3auth/base-solana-adapter":"2ow5g","@web3auth/solana-provider":"kX9zz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2ow5g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@web3auth/base":"7HmU4","bs58":"4ji3p","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1Hd44"], null, "parcelRequire8d7b")

//# sourceMappingURL=phantomAdapter.esm.44af147c.js.map
